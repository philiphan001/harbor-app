      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        <div className="text-center">
          ...
          <p className="font-sans text-sm text-slateMid mb-6 leading-relaxed">
            The readiness assessment encountered an error. Your previous answers
            have been saved.
          </p>
          <div className="flex flex-col gap-3">
            ...
            <Link
              href="/readiness/results"
              className="text-sage font-sans text-sm font-medium hover:opacity-80 transition-opacity"
            >
