-- Harbor Database Migration (idempotent — safe to re-run)
-- Generated from Prisma schema, modified with IF NOT EXISTS
...
CREATE TABLE IF NOT EXISTS "housing_assessment" (
    "id" TEXT NOT NULL,
    "situationId" TEXT NOT NULL,
    "homeType" TEXT,
    "floors" INTEGER,
...
CREATE UNIQUE INDEX IF NOT EXISTS "financial_profile_situationId_key" ON "financial_profile"("situationId");
CREATE UNIQUE INDEX IF NOT EXISTS "housing_assessment_situationId_key" ON "housing_assessment"("situationId");
CREATE INDEX IF NOT EXISTS "documents_situationId_idx" ON "documents"("situationId");
